...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        /**
         * 2018年5月1日01:37:10 增加whereSqlList Id
         */
        ATTR_WHERE_SQL_LIST_ID
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        //TODO 修改countByExample方法名称为count
        ...
        //TODO 修改insert方法为insertBatch
        setInsertStatementId("insertBatch"); //$NON-NLS-1$
        //TODO 修改insertSelective方法名称为insert
        setInsertSelectiveStatementId("insert"); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        //TODO 修改selectByExample方法名称为selectPageList
        setSelectByExampleStatementId("selectPageList"); //$NON-NLS-1$
        ...
        // TODO 修改updateByPrimaryKey方法名称为updateBatch
        setUpdateByPrimaryKeyStatementId("updateBatch"); //$NON-NLS-1$
        //TODO 修改updateByPrimaryKeySelective方法名称为update
        ...
        //TODO 增加setWhereSQLListId
        setWhereSQLListId("Where_List");
    ...
    /**
     * //TODO 增加whereSQLList Id
     * @param s
     */
    public void setWhereSQLListId(String s){
        internalAttributes.put(InternalAttribute.ATTR_WHERE_SQL_LIST_ID, s);
    }
    ...
    public String getWhereSQLListId(){
        return internalAttributes
                .get(InternalAttribute.ATTR_WHERE_SQL_LIST_ID);
    }
