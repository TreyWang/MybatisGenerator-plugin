...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        // TODO 增加WhereSQLList标签
        addWhereSQLListElement(answer);
        ...
        // TODO 修改count方法，并加到最后位置
        addCountByExampleElement(answer);
        // TODO 将默认的insert改为insertBatch
    ...
    protected void addWhereSQLListElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateWhereSQLList()) {
            AbstractXmlElementGenerator elementGenerator = new WhereSQLListElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
