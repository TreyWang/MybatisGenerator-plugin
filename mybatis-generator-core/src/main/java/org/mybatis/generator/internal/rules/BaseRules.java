...
//                || tableConfiguration.isUpdateByExampleStatementEnabled();
    ...
    public boolean generateCountByExample() {
        ...
        //TODO 修改利用whereListSQL标签
        boolean rc = tableConfiguration.isWhereSQLListStatementEnabled() &&
                tableConfiguration.isCountByExampleStatementEnabled();
     ...
     * @see org.mybatis.generator.internal.rules.Rules#generateBlobColumnList()
     */
    public boolean generateWhereSQLList() {
        if (isModelOnly) {
            return false;
        }

        return tableConfiguration.isWhereSQLListStatementEnabled();
    }
