...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        compilationUnit.addFileCommentLine(" * " + compilationUnit.getType().getShortName() +
                ".java " + compilationUnit.getType().getPackageName());
        compilationUnit.addFileCommentLine(" * <p>");
        compilationUnit.addFileCommentLine(" * ****************************************************************************");
        compilationUnit.addFileCommentLine(" * Change Log");
        compilationUnit.addFileCommentLine(" * <p>");
        compilationUnit.addFileCommentLine(" * 1. " + author + " created me at "+
                simpleDateFormat.format(new
                Date())
                +"" +
                " for class DESC. 2.");
        compilationUnit.addFileCommentLine(" * ****************************************************************************");
        compilationUnit.addFileCommentLine(" * Copyright (c) 2017, www.bibenet.com All Rights Reserved.O(∩_∩)O");
        compilationUnit.addFileCommentLine(" */");
    }
    ...
    public void addConfigurationProperties(Properties properties) {
        ...
        addFieldComments = isTrue(properties
                .getProperty(PropertyRegistry.COMMENT_GENERATOR_FIELD_COMMENTS));
        ...
        if(StringUtility.stringHasValue(properties.getProperty(PropertyRegistry
                .COMMENT_GENERATOR_SWAGGER))){
...
//        }
        ...
        innerClass
                .addJavaDocLine(" * " + introspectedTable.getFullyQualifiedTable().getRemarks()); //$NON-NLS-1$
        innerClass
                .addJavaDocLine(" * 实体类对应的数据表为: " + introspectedTable.getFullyQualifiedTable()
                        .toString())
        ; //$NON-NLS-1$
        sb.append(" * @author " + author); //$NON-NLS-1$
...
//        addJavadocTag(innerClass, false);
        ...
        //TODO 添加swagger的@ApiModel
        if(this.addSwaggerAnnotations){
            innerClass.addJavaDocLine("@ApiModel(value =\"" + entityName + "\")");
        }
    }
