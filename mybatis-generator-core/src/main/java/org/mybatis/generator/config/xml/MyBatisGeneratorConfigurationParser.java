...
public class MyBatisGeneratorConfigurationParser {
    ...
    protected void parseTable(Context context, Node node) {
        ...
        //TODO 2018年5月1日02:34:39
        String enableWhereSQLList = attributes
                .getProperty("enableWhereSQLList"); //$NON-NLS-1$
        ...
        if (stringHasValue(enableWhereSQLList)) {
            tc.setWhereSQLListStatementEnabled(
                    isTrue(enableWhereSQLList));
        }
