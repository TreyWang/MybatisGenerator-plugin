...
public class TableConfiguration extends PropertyHolder {
    ...
    /**
     * //TODO 2018年5月1日02:24:48增加是否增加whereSQLList标签
     */
    private boolean whereSQLListStatementEnabled;
    ...
    public TableConfiguration(Context context) {
        ...
        //TODO增加WhereSQLList标签开关
        whereSQLListStatementEnabled = true;

        setCountByExampleStatementEnabled(true);
    }
     ...
     * @return true, if is update by example statement enabled
     */
    public boolean isWhereSQLListStatementEnabled() {
        return whereSQLListStatementEnabled;
    }

    /**
     * Sets the update by example statement enabled.
     *
     * @param whereSQLListStatementEnabled
     *            the new update by example statement enabled
     */
    public void setWhereSQLListStatementEnabled(
            boolean whereSQLListStatementEnabled) {
        this.whereSQLListStatementEnabled = whereSQLListStatementEnabled;
    }
